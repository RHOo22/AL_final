...
const role_entity_1 = require("./roles/roles/role.entity");
        ...
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                entities: [
                    ...
                    role_entity_1.Role,
                    minute_entity_1.Minute
                ],
                synchronize: true,
            }), users_module_1.UsersModule, associations_module_1.AssociationsModule, auth_module_1.AuthModule, roles_module_1.RolesModule, minutes_module_1.MinutesModule
        ],
